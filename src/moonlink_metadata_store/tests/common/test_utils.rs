...
pub(crate) fn get_moonlink_table_config() -> MoonlinkTableConfig {
    let iceberg_accessor = AccessorConfig::new_with_storage_config(StorageConfig::FileSystem {
    ...
    MoonlinkTableConfig {
        iceberg_table_config: IcebergTableConfig {
            ...
            accessor_config: iceberg_accessor,
        },
        wal_table_config: WalConfig::new(wal_accessor, "dst-database.dst-schema.dst-table"),
        ..Default::default()
    }
}
